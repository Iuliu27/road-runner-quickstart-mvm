...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 11520.952683805295; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3616.840891476388; // x position of the perpendicular encoder (in tick units)
    }
