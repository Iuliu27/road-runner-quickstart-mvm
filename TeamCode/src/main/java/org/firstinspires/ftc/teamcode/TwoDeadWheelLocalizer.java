...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 11373.453129394667; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3991.2633454152174; // x position of the perpendicular encoder (in tick units)
    }
